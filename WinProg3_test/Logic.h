...
enum BagicGateType {
	ANDSHAPE, ORSHAPE, NOTSHAPE,NANDSHAPE,NORSHAPE,XORSHAPE, INPUTTRUE, INPUTFALSE, OUTPUTTRUE, OUTPUTFALSE, OUTPUTCLOCK,SEVENSEGMENT,LINEBRANCH ,LINESHAPE, TFFSHAPE, DFFSHAPE, JKFFSHAPE, NONE
};
